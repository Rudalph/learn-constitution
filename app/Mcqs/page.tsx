    ...
    return (
        <div className='flex flex-col justify-center items-center '>
            ...
            <div className='hidden lg:fixed bottom-0 z-50 border-t-2 border-[#E5E5E5] w-full lg:flex justify-center align-middle items-center'>
                <div className='flex justify-between lg:w-[900px] flex-wrap gap-5 pt-12 pb-12'>
                <button className="btn w-40 rounded-2xl bg-[white] text-[#9D9D9D] border border-[#9D9D9D] font-extrabold text-lg shadow-[0_5px_0_#9D9D9D] hover:bg-[#E5E5E5]">SKIP</button>
                <button className="btn w-40 rounded-2xl bg-[#58CC02] text-white font-extrabold border-[#58CC02] text-lg shadow-[0_5px_0_#3FA001] hover:bg-[#61E002]">CHECK</button>
                </div>
            </div>
        </div>
